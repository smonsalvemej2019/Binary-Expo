//This program will ask the user to input a base, an exponent and a modulo //it will make use of binary representation and modular exponentiation //The output should be the based (a) raised to the power (k) mod modulo(n)

//binary representation prototype void biconversion(int k, vector &bi);

//Modular Exponentiation prototype int exponent(int a, int k, int n, vectorbi);
...
//binary representation function definition void biconversion(int k, vector &bi) {
...
//modular exponintiation function definition int exponent(int a, int k, int n, vectorbi) {
